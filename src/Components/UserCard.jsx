...
const UserCard = ({ user }) => {
  ...
  return (
    <div className="card w-72 h-[40%] bg-base-200 shadow-lg shadow-white/10 hover:shadow-white/20 transition-shadow duration-300 border border-white/10 rounded-2xl overflow-hidden">
      <figure className="h-33 bg-base-300">
