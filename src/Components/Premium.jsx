const Premium = () => {
  ...
  return (
    <div class="grid lg:grid-cols-2 px-8 gap-10 text-zinc-800 mt-10 mr-100">
      <div class="flex flex-col items-center bg-slate-100 p-8 rounded-lg shadow-lg max-w-sm">
        <div>
          ...
          <p class="opacity-60 text-center">For Beginner Developers</p>
          <div class="flex flex-col items-center my-8">
            <p class="font-extrabold text-4xl">₹ 150</p>
        ...
        <div class="flex flex-col gap-1">
          ...
          <div class="flex justify-center mt-8 ">
            <button
              class="border px-4 py-2 border-violet-400 border-4 hover:bg-violet-100 rounded-xl"
      ...
      <div class="flex flex-col items-center bg-gradient-to-br from-blue-100 via-orange-100 to-purple-100 p-8 rounded-lg shadow-lg relative border-8 border-orange-200 max-w-sm">
        ...
        <div>
          ...
          <p class="opacity-60 text-center">For more Experienced Developers</p>
          <p class="opacity-60 text-center"></p>
          <div class="flex gap-4 justify-center">
            <div class="flex flex-col items-center my-8">
              <p class="font-extrabold text-4xl">₹ 250</p>
              <p class="text-sm opacity-60">/month</p>
            </div>
          </div>
        </div>
        <div class="flex flex-col gap-1">
          ...
          <div class="flex justify-center mt-8">
            <button
              ...
              class="px-4 py-2 border-violet-400 border-4 hover:bg-violet-100 rounded-xl"
            >
              Get Started
            </button>
          </div>
